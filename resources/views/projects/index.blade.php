    ...
    <main class="flex flex-wrap -mx-3">
        @forelse ($projects as $project)
                <div class="w-1/3 px-3 pb-6">
                    <div class="bg-white p-5 shadow-md rounded" style="height:16rem">
                        <h1 class="text-xl font-semibold py-4 -ml-5 border-l-4 border-blue-brand pl-4">{{ $project->title }}</h1>
